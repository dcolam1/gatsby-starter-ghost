module.exports = {
    siteUrl: `https://sliding-digits.herokuapp.com`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Sliding Digits`, // Used for App manifest e.g. Mobile Home Screen
